...
ArrayAdapter <String> arr2=new ArrayAdapter<String>(this,android.R.layout.simple_dropdown_item_1line,var.hospitals);
...
public void onItemClick(AdapterView<?> parent, View arg1, int pos,long id) {
	p.performCompletion();
	man1.hospital1(p.getText().toString());
	
}
});
try {
gps = new GPSTracker(Sub1.this);
...
public boolean onOptionsItemSelected(MenuItem item){
	...
	Toast.makeText(Sub1.this, "search", Toast.LENGTH_LONG).show();
	break;
	case R.id.mapview:
	Toast.makeText(Sub1.this, "Mapview", Toast.LENGTH_LONG).show();
	break;

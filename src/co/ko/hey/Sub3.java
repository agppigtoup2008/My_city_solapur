...
ArrayAdapter <String> arr3=new ArrayAdapter<String>(this,android.R.layout.simple_dropdown_item_1line,var.GasStations);
...
public void onItemClick(AdapterView<?> parent, View arg1, int pos,long id) {
	p.performCompletion();
	man3.GasStation1(p.getText().toString());
	
}
});
try {
gps = new GPSTracker(Sub3.this);
...
public boolean onOptionsItemSelected(MenuItem item){
	...
	Toast.makeText(Sub3.this, "search", Toast.LENGTH_LONG).show();
	break;
	case R.id.mapview:
	Toast.makeText(Sub3.this, "Mapview", Toast.LENGTH_LONG).show();
	break;
